...
export default function CodeEditor({ code: initialCode, language: initialLanguage = 'typescript' }: CodeEditorProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto rounded-lg overflow-hidden bg-zinc-950 text-zinc-50">
